...
<head>
  ...
  <style>
    :root { color-scheme: light; --p:#1d1d1f; --p2:#f2f2f2; --bg:#f5f5f7; --card:#ffffff; --text:#1d1d1f; --muted:#6e6e73; --line:#d2d2d7; }
    * { box-sizing: border-box; }
    body { margin:0; font-family:-apple-system,BlinkMacSystemFont,"Segoe UI","PingFang SC","Microsoft YaHei",sans-serif; color:var(--text); background:#f5f5f7; }
    .wrap { max-width: 1180px; margin: 0 auto; padding: 32px 18px 56px; }
    .hero { border-radius: 28px; padding: 28px; background:#ffffff; border:1px solid var(--line); box-shadow:0 18px 50px rgba(0,0,0,.06); }
    ...
    .card { background:var(--card); border:1px solid var(--line); border-radius:22px; padding:18px; box-shadow:0 10px 28px rgba(0,0,0,.05); }
    ...
    th { background:#f2f2f2; color:#1d1d1f; font-weight:800; }
    tr:last-child td { border-bottom:0; }
    .pill,.uid { display:inline-block; padding:4px 9px; border-radius:999px; background:var(--p2); color:#1d1d1f; font-weight:700; font-size:12px; }
